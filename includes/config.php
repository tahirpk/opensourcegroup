...
$config['Database']['dbname'] = 'opensourcegroup_com';
...
$config['Database']['technicalemail'] = 'tahirpk@gmail.com';
...
$config['MasterServer']['servername'] = 'mysql-shared-02.phpfog.com';
$config['MasterServer']['port'] = 3306;

	//	****** MASTER DATABASE USERNAME & PASSWORD ******
	//	This is the username and password you use to access MySQL.
	//	These must be obtained through your webhost.
$config['MasterServer']['username'] = 'admin-786-62646';
$config['MasterServer']['password'] = 'uk36j44q76CV';
